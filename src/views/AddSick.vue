        ...
        .form
            el-form(label-position='left', :model='ruleForm', :rules="rules", status-icon, ref="ruleForm", class="creator-form")
                ...
                el-row(:gutter="20")
                    el-col(:span="12")
                        el-form-item(prop="thridName", :class="{'not-empty': ruleForm.thridName !== ''}")
                            ...
                            .label Отчество
                    el-col(:span="12")
                        el-form-item(prop="individualNumber", :class="{'not-empty': ruleForm.individualNumber !== ''}")
                            el-input(v-model='ruleForm.individualNumber', autocomplete="off",  type='number')
                ...
                el-row(:gutter="20")
                    ...
                    el-col(:span="10")
                        el-form-item(prop="dateEntry")
                            el-date-picker(v-model='ruleForm.dateEntry', type='date', placeholder='Дата поступления')
                    el-col(:span="4")
            ...
            .controls
                ...
                .btn-primary.press(@click="submitForm()", :class="{'disabled-btn': disabledBtn}") Добавить
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        individualNumber: [{ validator: validateIndividualNumber, trigger: "blur" }],
        dateBorn: [{ validator: validateDate, trigger: "blur" }],
        dateEntry: [{ validator: validateDate, trigger: "blur" }],
      }
    };
  },
  methods: {
